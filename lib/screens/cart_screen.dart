...
class _CartItemWidget extends StatelessWidget {
  ...
  const _CartItemWidget({required this.cartProvider, required this.item});

  @override
  Widget build(BuildContext context) {
    final productProvider = context.read<ProductProvider>();

    /// получаем размеры от родителя (не больше 550 в ширину)
    return LayoutBuilder(builder: (context, constraints) {
      final imageWidth = constraints.maxWidth * 0.43;
      final imageHeight = imageWidth * 0.75; // например, соотношение 4:3
